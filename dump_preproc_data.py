...
def main():
	...
	dataset = SubGraphDataset(args.dataset_path, args.split, args.neigh_size, args.position_enc_type, args.sampling_type, args.pos_enc_dim, args.graph_connection, device, True, args)
	...
	dataset = SubGraphDataset(args.dataset_path, args.split, args.neigh_size, args.position_enc_type, args.sampling_type, args.pos_enc_dim, args.graph_connection, device, False, args)
	my_collator = MyCollatorCustom(dataset.triples_dataset.entity2id['<pad>'], dataset.triples_dataset.relation2id['<pad>'], position_enc_type=args.position_enc_type)
	...
	with torch.no_grad():
		for batch_id, batch in enumerate(tqdm(dataloader)):
			pickle.dump(batch, open(os.path.join(args.out_dir, '{}_{}_{}_{}_{}_{}'.format(args.sampling_type, args.graph_connection, args.position_enc_type, args.split, args.batch_size, args.adj_type), '{}.pkl'.format(batch_id)), 'wb'))
